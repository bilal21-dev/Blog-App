...
//   return (
//     <div className="news-ticker-container bg-gray-800 text-white">
...
//             <div
//               key={index}
//               className="news-item flex items-center space-x-4 p-2 bg-gray-700 rounded-lg shadow-md hover:bg-gray-600 transition duration-300"
//             >
//               <img
...
//               />
//               <div className="news-text space-y-1">
//                 <p className="news-title text-lg font-semibold text-white">{article.title}</p>
//                 <p className="news-description text-sm text-gray-300">
...
//   if (loading) return <div>Loading...</div>; // Show loading message if still fetching
...
//     const loadNews = async () => {
//       try {
//         const data = await fetchTopHeadlines('us', 'sports'); // Example: US Technology news
//         setArticles(data);
//         setLoading(false);
//       } catch (error) {
//         console.error('Error loading news:', error);

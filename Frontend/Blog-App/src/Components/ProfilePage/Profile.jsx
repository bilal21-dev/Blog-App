    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            <div className="flex flex-col gap-4 md:flex-row outer px-3 py-2 ">
                <div className="bg-slate-200 md:w-1/4 w-full p-4 min-h-screen rounded-md shadow-lg shadow-black flex flex-col">
                ...
                <div className="bg-slate-200 md:w-3/4 w-full p-4 rounded-md shadow-lg shadow-black">
